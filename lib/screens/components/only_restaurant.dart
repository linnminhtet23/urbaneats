...
import 'package:urban_eats/screens/detailscreens/only_restaurant_detail.dart';
import 'package:urban_eats/screens/restaurantdetail.dart';
import 'package:urban_eats/style/theme.dart' as Style;

class OnlyRestaurant extends StatefulWidget {
  @override
  _OnlyRestaurantState createState() => _OnlyRestaurantState();
}

class _OnlyRestaurantState extends State<OnlyRestaurant> {
  @override
  ...
  Widget build(BuildContext context) {
    OnlyRestaurantNotifier onlyrestaurantNotifier =
        Provider.of<OnlyRestaurantNotifier>(context);
    getOnlyRestaurant(onlyrestaurantNotifier);
        ...
        children: [
          ...
          Container(
            ...
            child: ListView.builder(
                ...
                itemCount: onlyrestaurantNotifier.onlyrestaurantList.length,
                itemBuilder: (context, index) {
                  return Padding(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        onlyrestaurantNotifier.currentonlyRestaurant =
                            onlyrestaurantNotifier.onlyrestaurantList[index];
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              onlyrestaurantNotifier
                                  .onlyrestaurantList[index].restaurantName,
                              maxLines: 2,
                              style: TextStyle(
                                  height: 1.4,
                                  color: Colors.black,
